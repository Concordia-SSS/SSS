 ...
 * <li>{@link reservationsystem.Booking#getSpecificFlight <em>Specific Flight
 * </em>}</li>
 * <li>{@link reservationsystem.Booking#getBookNo <em>Book No</em>}</li>
 * <li>{@link reservationsystem.Booking#getBookingStatus <em>Booking Status
 * </em>}</li>
...
public interface Booking extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Passenger</b></em>' reference list. The
	 * list contents are of type {@link reservationsystem.Passenger}. It is
	 * bidirectional and its opposite is '
	 * {@link reservationsystem.Passenger#getBooking <em>Booking</em>}'. <!--
	 * begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Specific Flight</b></em>' reference
	 * list. The list contents are of type
	 * {@link reservationsystem.SpecificFlight}. It is bidirectional and its
	 * opposite is '{@link reservationsystem.SpecificFlight#getBooking
	 * <em>Booking</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Specific Flight</em>' reference list isn't
	 ...
	 * @generated
	 */
	SpecificFlight getSpecificFlight();

	/**
	 * Returns the value of the '<em><b>Book No</b></em>' attribute. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Book No</em>' attribute isn't clear, there
	...
	/**
	 * Sets the value of the '{@link reservationsystem.Booking#getBookNo
	 * <em>Book No</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Book No</em>' attribute.
	 * @see #getBookNo()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link reservationsystem.Booking#getBookingStatus
	 * <em>Booking Status</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Booking Status</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Seats</b></em>' reference list. The list
	 * contents are of type {@link reservationsystem.Seat}. It is bidirectional
	 * and its opposite is '{@link reservationsystem.Seat#getBook <em>Book</em>}
	 * '. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Seats</em>' reference list isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link reservationsystem.Booking#getBaggageInfo
	 * <em>Baggage Info</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Baggage Info</em>' attribute.
	 * @see #getBaggageInfo()
	 * @generated
	 */
